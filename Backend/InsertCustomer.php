		...
		while ( $row = $result-> fetch() )
			{
				...
				if($row['dbcustmailinglist'] == 1){
					$maillist = 'Yes';
				}
				else{
					$maillist = 'No';
				}
				echo '<tr><td>' . $row['dbcustfirstname'] . '</td><td> ' . $row['dbcustlastname'] 
				. '</td><td> ' . $row['dbcustemail'] . '</td><td> ' . $row['dbcustaddress'] 
				. '</td><td> ' . $row['dbcustcity'] . '</td><td> ' . $row['dbcuststate']. '</td>
				<td> ' . $row['dbcustzip']. '</td><td>' . $row['dbcustphone']
				. '</td><td> ' . $maillist . '</td></tr>';
			}
		?>
	</table>
	<?php
